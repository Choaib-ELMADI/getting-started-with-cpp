...
int main() {
    ...
    Shape *oval1_ptr = &oval1;//! Dynamic binding ==> compiler checks the type of the actual object and calls the right method
    oval1_ptr->draw();//! Call the draw method in the Oval class
    Oval *circle1_ptr = &circle1;
    circle1_ptr->draw();//! Call the draw method in the Circle class

    //* Base references
    std::cout << "--------------------" << std::endl;
    std::cout << "Base references" << std::endl;
    Shape& oval1_ref = oval1;//! Dynamic binding ==> compiler checks the type of the actual object and calls the right method
    oval1_ref.draw();//! Call the draw method in the Oval class
    Oval& circle1_ref = circle1;
    circle1_ref.draw();//! Call the draw method in the Circle class
